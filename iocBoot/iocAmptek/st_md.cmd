...
dbLoadRecords("$(MCA)/db/mca.db","P=mcaTest:,M=mca4,NCHAN=8192,DTYP=asynMCA,INP=@asyn(Amptek4)")
...
dbLoadRecords("$(MCA)/db/Amptek.db","P=mcaTest:,R=Amptek4:,PORT=Amptek4")
...
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=mcaTest:,R=asyn4,PORT=Amptek4,ADDR=0,OMAX=256,IMAX=256")
...
create_monitor_set("auto_settings.req",30,"P=mcaTest:,M=mca4,R=Amptek4:")

#asynReport 1 Amptek1
#asynReport 1 Amptek2
#asynReport 1 Amptek3
#asynReport 1 Amptek4
