/* aimRegister.c
 *
 *   01-Feb-2003  Jens Eden  
 *
 *   Register Commands AIMConfig / setMcaDebug for iocsh
 */
...
static const iocshArg MCADebugArg0 = { "aimDebug",iocshArgInt};
static const iocshArg MCADebugArg1 = { "mcaAIMServerDebug",iocshArgInt};
static const iocshArg MCADebugArg2 = { "mcaRecordDebug",iocshArgInt};
static const iocshArg MCADebugArg3 = { "devMcaMpfDebug",iocshArgInt};
static const iocshArg * const MCADebugArgs[4] = {&MCADebugArg0,
                                                 &MCADebugArg1,
                                                 &MCADebugArg2,
                                                 &MCADebugArg3};
static const iocshFuncDef MCADebugFuncDef = {"setMcaDebug",4,MCADebugArgs};
static void MCADebugCallFunc(const iocshArgBuf *args)
{
    aimDebug = (int)args[0].sval;
    mcaAIMServerDebug = (int)args[1].sval;
    mcaRecordDebug = (int)args[2].sval;
    devMcaMpfDebug = (int)args[3].sval;
}
...
epicsExportRegistrar(aimRegister);
